      ...
      <div className="relative max-w-4xl mx-auto px-6 lg:px-8 text-center">
        ...
        <div className="mb-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 text-sm text-gray-300">
            ...
            <div className="flex items-center justify-center gap-2">
              <div className="w-6 h-6 bg-purple-500/20 border border-purple-500/50 rounded-full flex items-center justify-center shrink-0">
                <span className="text-purple-400 text-xs font-bold">2</span>
              </div>
              <span>Discuss your goals & challenges</span>
            </div>
            <div className="flex items-center justify-center gap-2">
              <div className="w-6 h-6 bg-pink-500/20 border border-pink-500/50 rounded-full flex items-center justify-center shrink-0">
